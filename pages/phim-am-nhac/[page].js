...
import { getAllPhimAmNhac, getOnePhimAmNhac } from "@/pages/api/getData";
...
export default function PhimAmNhac({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Với Các Bài Hát Hay"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimAmNhac(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimAmNhac();
