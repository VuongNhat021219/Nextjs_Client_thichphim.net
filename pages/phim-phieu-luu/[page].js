...
import { getAllPhimPhieuLuu, getOnePhimPhieuLuu } from "@/pages/api/getData";
...
export default function PhimPhieuLuu({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Phiêu Lưu"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimPhieuLuu(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimPhieuLuu();
