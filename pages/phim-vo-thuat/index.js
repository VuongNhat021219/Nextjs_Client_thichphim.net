...
import { getOnePhimVoThuat } from "@/pages/api/getData";
...
export default function PhimVoThuatIndex({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Võ Thuật Hay Nhất"
