...
import { getOnePhimKinhDien, getAllPhimKinhDien } from "@/pages/api/getData";
...
export default function PhimKinhDien({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Kinh Điển"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimKinhDien(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimKinhDien();
