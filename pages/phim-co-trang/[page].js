...
import { getOnePhimCoTrang, getAllPhimCoTrang } from "@/pages/api/getData";
...
export default function PhimCoTrang({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimCoTrang(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimCoTrang();
