...
import { getOnePhimKinhDi, getAllPhimKinhDi } from "@/pages/api/getData";
...
export default function PhimKinhDi({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Ma Hay Nhất"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimKinhDi(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimKinhDi();
