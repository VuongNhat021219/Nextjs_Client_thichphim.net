...
import { getOnePhimVienTuong, getAllPhimVienTuong } from "@/pages/api/getData";
...
export default function PhimVienTuong({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh sách phim viễn tưởng"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimVienTuong(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimVienTuong();
