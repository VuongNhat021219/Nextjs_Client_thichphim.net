...
import { getAllPhimHocDuong, getOnePhimHocDuong } from "@/pages/api/getData";
...
export default function PhimHocDuong({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Học Đường"
...
export async function getStaticPaths() {
  ...
  const data = await getAllPhimHocDuong();
