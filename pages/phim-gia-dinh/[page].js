...
import { getOnePhimGiaDinh, getAllPhimGiaDinh } from "@/pages/api/getData";
...
export default function PhimGiaDinh({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimGiaDinh(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimGiaDinh();
