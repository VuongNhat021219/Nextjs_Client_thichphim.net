...
import { getOnePhimHanhDong, getAllPhimHanhDong } from "@/pages/api/getData";
...
export default function PhimHanhDong({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimHanhDong(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimHanhDong();
