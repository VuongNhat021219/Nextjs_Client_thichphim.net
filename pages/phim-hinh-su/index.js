...
import { getOnePhimHinhSu } from "@/pages/api/getData";
...
export default function PhimHinhSuIndex({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
