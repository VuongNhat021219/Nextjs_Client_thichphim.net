...
import { getOnePhimTaiLieu, getAllPhimTaiLieu } from "@/pages/api/getData";
...
export default function PhimTaiLieu({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticPaths() {
  const data = await getAllPhimTaiLieu();
