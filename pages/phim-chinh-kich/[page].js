...
import { getOnePhimChinhKich, getAllPhimChinhKich } from "@/pages/api/getData";
...
export default function PhimChinhKich({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Chính Kịch"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimChinhKich(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimChinhKich();
