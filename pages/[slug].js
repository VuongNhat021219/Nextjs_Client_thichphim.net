...
import { getDataMoviesOne } from "@/pages/api/getData";
    ...
    const fetchMovie = async () => {
      try {
        if (slug !== "[slug]" && slug !== undefined) {
          const data = await getDataMoviesOne(slug);
                    ...
                    <Col xs={4}>
                      <div className={detailCSS.detail__content___list___left}>
                        ...
                        <div className={detailCSS.detail__list___ribbon}>
                          ...
                          <div
                            className={
                              detailCSS.detail__list___ribbon___action1
                            }
                          >
                            {" "}
                            {movie.movie?.lang}
                        ...
                        <div className={detailCSS.detail__right___list}>
                          <Row>
                            <Col xs={9}>
                              <div
                                className={
                                  detailCSS.detail__right___list___title
                                }
                              >
                            ...
                            <Col>
                              <div
                                className={
                                  detailCSS.detail__right___list___vote
                                }
                              >
                                <div
                                  className={
