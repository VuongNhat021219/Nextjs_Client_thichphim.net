...
import { getOnePhimTheThao, getAllPhimTheThao } from "@/pages/api/getData";
...
export default function PhimTheThao({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimTheThao(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimTheThao();
