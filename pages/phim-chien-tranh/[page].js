...
import {
  getOnePhimChienTranh,
  getAllPhimChienTranh,
...
export default function PhimChienTranh({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Chiến Tranh"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimChienTranh(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimChienTranh();
