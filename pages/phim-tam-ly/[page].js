...
import { getOnePhimTamLy, getAllPhimTamLy } from "@/pages/api/getData";
...
export default function PhimTamLy({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimTamLy(page);
...
export async function getStaticPaths() {
  const data = await getAllPhimTamLy();
