...
import { getOnePhimThanThoai, getAllPhimThanThoai } from "@/pages/api/getData";
...
export default function PhimThanThoai({ data, allTrendMovieDatas }) {
  return (
    <div className={`app`}>
      <Layout>
                ...
                <Row>
                  <Col>
                    {data === undefined ? (
                      ...
                      <MovieList
                        title="Danh Sách Phim Thần Thoại"
...
export async function getStaticProps({ params }) {
  ...
  const data = await getOnePhimThanThoai(page);
...
export async function getStaticPaths() {
  ...
  const data = await getAllPhimThanThoai();
